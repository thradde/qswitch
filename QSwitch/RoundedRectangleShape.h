...
class RoundedRectangleShape : public sf::Shape
{
    public:
        ...
        /// \param corner_radius Radius for each rounded corner
        /// \param pointCount Number of points of each corner
        ///
        ////////////////////////////////////////////////////////////
        explicit RoundedRectangleShape(const Vector2f& size = Vector2f(0, 0), float corner_radius = 5, unsigned int cornerPointCount = 20);
